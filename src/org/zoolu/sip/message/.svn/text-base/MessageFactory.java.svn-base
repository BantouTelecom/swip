...
public class MessageFactory extends org.zoolu.sip.message.BaseMessageFactory
{
   ...
   public Message createMessageRequest(SipProvider sip_provider, NameAddress recipient, NameAddress from, String subject, String type, String body)
   ...
   public Message createReferRequest(SipProvider sip_provider, NameAddress recipient, NameAddress from, NameAddress contact, NameAddress refer_to/*, NameAddress referred_by*/)
   {  SipURL request_uri=recipient.getAddress();
      String callid=sip_provider.pickCallId();
      int cseq=SipProvider.pickInitialCSeq();
      String localtag=SipProvider.pickTag();
   ...
   /** Creates a new REFER request (RFC3515) within a dialog
     ...
     */
   public Message createReferRequest(Dialog dialog, NameAddress refer_to, NameAddress referred_by)
   ...
   public Message createSubscribeRequest(SipProvider sip_provider, SipURL recipient, NameAddress to, NameAddress from, NameAddress contact, String event, String id, String content_type, String body, String remoteTag)
   {  Message req=createRequest(sip_provider,SipMethods.SUBSCRIBE,recipient,to,from,contact,null, id, remoteTag);
      //req.setEventHeader(new EventHeader(event,id)); -> 489
   ...
   /** Creates a new SUBSCRIBE request (RFC3265) out of any pre-existing dialogs. */
   public Message createSubscribeRequest(SipProvider sip_provider, SipURL recipient, NameAddress to, NameAddress from, NameAddress contact, String event, String id, String content_type, String body, String fromTag, String toTag)
   {  Message req=createRequest(sip_provider,SipMethods.SUBSCRIBE,recipient,to,from,contact,null, id, fromTag, toTag);
      //req.setEventHeader(new EventHeader(event,id)); -> 489
      req.setEventHeader(new EventHeader(event));   
      req.setBody(content_type,body);
      return req;
   ...
   public Message createSubscribeRequest(Dialog dialog, String event, String id, String content_type, String body)
   ...
   // RFC3903
   public Message createSubscribeRequest(Dialog dialog, String event, String content_type, String body)
   {  Message req=createRequest(dialog,SipMethods.SUBSCRIBE,null);
      req.setEventHeader(new EventHeader(event));
      req.setBody(content_type,body);
      return req;
   ...
   public Message createNotifyRequest(Dialog dialog, String event, String id, String content_type, String body)
   ...
   /** Creates a new NOTIFY request (RFC3265) within a dialog */
   public Message createNotifyRequest(Dialog dialog, String event, String id, String sipfragment)
   {  Message req=createRequest(dialog,SipMethods.NOTIFY,null);
      req.removeExpiresHeader();
      req.setEventHeader(new EventHeader(event,id));
   ...
   public Message createPublishRequest(SipProvider sip_provider, NameAddress from, String event)
   {  SipURL request_uri=from.getAddress();
      String callid=sip_provider.pickCallId();
      int cseq=SipProvider.pickInitialCSeq();
      String localtag=SipProvider.pickTag();
      //String branch=SipStack.pickBranch();
      Message req=createRequest(sip_provider,SipMethods.PUBLISH,request_uri,from,from,null,callid,cseq,localtag,null,null,null);
      req.setEventHeader(new EventHeader(event));
      //if (subject!=null) req.setSubjectHeader(new SubjectHeader(subject));
      //req.setBody(type,body);     
      return req;
