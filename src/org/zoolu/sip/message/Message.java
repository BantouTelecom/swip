...
import org.zoolu.sip.header.PrivacyHeader;
...
public void setPrivacyHeader(PrivacyHeader privacyHeader) {
	setHeader(privacyHeader);
	
}

public void setPPreferredIdentityHeader(
		PPreferredIdentityHeader preferredIdentityHeader) {
	setHeader(preferredIdentityHeader);
