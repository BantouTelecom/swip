...
public class AudioClipPlayer implements LineListener 
{
   ...
   {  
	  Logger.debug("Looping audio clip:"+clip);
	   state = PLAYING;
      rewind(); 
      if (clip!=null)
   ...
   {  
      ...
      {
    	  clip.start();
    	  Logger.debug("Starting audio clip "+clip);    	  
      }
      else Logger.debug("Audio clip is null");
      state=PLAYING;
   }
   ...
   {  
      if (clip!=null)
      {
    	  Logger.debug("Stopping audio clip "+clip);
    	  clip.stop();
      }
      else Logger.debug("Audio clip is null");
      state = STOPPED;
   ...
   {  
      if (clip!=null)
      {
    	  Logger.debug("rewinding audio clip"+clip);
   ...
   {  
      if (clip!=null) 
      { 
    	  Logger.debug("Replaying audio clip "+clip);
    	  rewind();
    	  clip.start();
    	  state=PLAYING;    	  
    	  }
